...
class ListItem(models.Model):
  ...
  class Meta:
    ...
    #  THIS IS BULLSHIT I HAVE SUBMITTED CODE EVERY DAY FOR 4 DAYS AND NONE OF THIS SHIT SHOWS ON GITHUB WHAT ACTYUAL BULLSHIT IF THIS NOW SHOWS BUT ALL MY OTHER WORK HASNT